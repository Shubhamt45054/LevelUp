      ...
      <div className="container" id="marginbetweennavigationbarandjumbotron">
        <div className="row">
          <div className="col-xs-12">
            ...
            text-primary" style={{ margin: '0px', padding: '0px', fontFamily: 'Droid Sans, sans-serif' }}>Search Jobs, Across all India.</h2>
            <hr />

            <form className="form-group form-inline text-center">

              <input type="text" className="form-control" placeholder="Enter Job Title,Desigination,Keywords" style={{ width: '300px', margin: '10px' }} />
